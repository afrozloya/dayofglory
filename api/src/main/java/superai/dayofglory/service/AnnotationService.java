...
public class AnnotationService {
    ...
    @Autowired
    public AnnotationService(FileStorageProperties fileStorageProperties) {
    ...
    public Resource loadFileAsResource(String fileName) {
        try {
            ...
            if(resource.exists()) {
                ...
                throw new TaskFileNotFoundException("File not found " + fileName);
            }
        } catch (MalformedURLException ex) {
            throw new TaskFileNotFoundException("File not found " + fileName, ex);
        }
    }
}
